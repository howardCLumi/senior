        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                <FormGroup sx={{marginLeft: '10%'}}>
                    ...
                    <FormControlLabel control={<Checkbox />} label="Jon Giblin" />
                    <FormControlLabel control={<Checkbox />} label="Howard Chi" />
                    <FormControlLabel control={<Checkbox />} label="Hailee Leonard" />
                </FormGroup>
            </Drawer>
            <Main open={open}>
                <DrawerHeader />
